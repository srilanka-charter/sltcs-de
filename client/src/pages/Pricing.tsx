...
const TIERS: { key: TierKey; label: string; badge?: string; color: string; features: string[] }[] = [
  {
    ...
    color: "#cd7f32",
    features: [
      "Fahrer im Praktikum zugeteilt",
      "Transferservice inkl. Hotel- und Restaurant-Abholung/-Abgabe",
      "Englischsprachiger lokaler Koordinator",
      "Sauberes klimatisiertes Fahrzeug",
      "Empfohlener Plan für kostenbewusstes Reisen",
    ],
  },
  {
    key: "silver",
    ...
    color: "#c9a84c",
    features: [
      "Staatlich zertifizierter Touristenfahrer oder höher",
      "Begleitung & Führung an Sehenswürdigkeiten",
      "Englischsprachiger lokaler Koordinator",
      "Safari- & Aktivitätsarrangements",
      "Führungsservice ohne Aufpreis",
    ],
  },
  {
    key: "gold",
    ...
    color: "#d4af37",
    features: [
      "Hochbewerteter Chauffeur-Guide-Fahrer garantiert",
      "Vollständige Reisebegleitung & Führung an Sehenswürdigkeiten",
      "Englischsprachiger lokaler Koordinator",
      "Duales Supportsystem",
      "Safari- & Aktivitätsarrangements",
    ],
  },
];
...
const VEHICLES: { key: VehicleKey; label: string; capacity: string }[] = [
  { key: "sedan", label: "Limousine", capacity: "1–3 Personen" },
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sri Lanka Mietwagen{" "}
          <em style={{ color: "#c9a84c", fontStyle: "italic" }}>Preise</em>
        </h1>
        <p
          style={{
        ...
        >
          Transparente Pauschaltarife zu branchenführend günstigen Preisen — für eine sichere und sorgenfreie Reise durch Sri Lanka.
        </p>
      </section>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px 32px" }}>
        ...
        <section style={{ padding: "56px 0 0" }}>
          <p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.8, fontSize: "0.95rem", maxWidth: "820px" }}>
            Bei Sri Lanka Taxi Charter Service (SLTCS) halten wir unsere Preise so niedrig wie möglich, ohne dabei die höchste Servicequalität zu beeinträchtigen. Wir sind der Überzeugung, dass ein weiteres Absenken das Erlebnis gefährden würde, das wir zu bieten verpflichtet sind.
          </p>
        </section>
        ...
        >
          ...
          >
            ⚠ Risiken bei der Wahl von Billigstangeboten
          </h2>
          <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.9rem", lineHeight: 1.7, marginBottom: "14px" }}>
            Dienste, die ausschließlich über den Preis konkurrieren, können folgende Probleme verursachen:
          </p>
          <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
            {[
              "Große Diskrepanz zwischen dem angebotenen Preis und dem tatsächlich berechneten Betrag",
              "Kein englischer Support ab der ersten Anfrage",
              "Zuteilung alter oder schlecht gewarteter Fahrzeuge",
              "Ständige Umwege zu Geschäften mit Kickback-Vereinbarungen, die Ihre Reiseroute stören",
            ].map((item) => (
              <li
                key={item}
                style={{
          ...
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.85rem", lineHeight: 1.7, marginTop: "16px" }}>
            Insbesondere einige scheinbar günstige Dienste erheben Kilometerbegrenzungen und berechnen Überschreitungen extra. Es gab Fälle, in denen Fahrer überhöhte Distanzen angaben, was zu Rechnungen weit über den Erwartungen führte.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "8px" }}>
          ...
          >
            SLTCSs transparente Pauschalpreise
          </h2>
          <p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.8, fontSize: "0.95rem", maxWidth: "820px" }}>
            SLTCS bietet ein Festpreisangebot basierend auf Ihrer Reiseroute, das bereits bei der ersten Anfrage auf Englisch besprochen wird. Auch wenn Ihre Reiseroute noch nicht feststeht, teilen Sie uns einfach die Orte mit, die Sie besuchen möchten, und wir schlagen die beste Route mit einem detaillierten Kostenvoranschlag vor.
          </p>
          <p style={{ color: "rgba(255,255,255,0.75)", lineHeight: 1.8, fontSize: "0.95rem", maxWidth: "820px", marginTop: "12px" }}>
            Alle unten aufgeführten Preise sind <strong style={{ color: "#fff" }}>inklusive Steuern</strong> und gelten für <strong style={{ color: "#fff" }}>englischsprachige Fahrer</strong>. Wir bieten drei Pläne an, die zu Ihrem Reisestil passen.
          </p>
        </section>
        ...
        <section style={{ marginTop: "0", paddingTop: "0" }}>
          ...
          >
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: "0.85rem", lineHeight: 1.7, margin: 0 }}>
              <strong style={{ color: "#c9a84c" }}>Hinweis:</strong> Die unten aufgeführten Preise gelten für Standardreiserouten. Zusätzliche Gebühren können anfallen, wenn die Gesamtdistanz die Standardschätzung überschreitet oder wenn der Abholungs- oder Abgabepunkt außerhalb des Flughafenbereichs liegt (einschließlich Colombo und Negombo).
            </p>
          </div>
        ...
        <section style={{ textAlign: "center", marginTop: "0" }}>
          <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.95rem", marginBottom: "24px" }}>
            Nicht sicher, welcher Plan zu Ihnen passt? Kontaktieren Sie uns für eine kostenlose, individuelle Schätzung.
          </p>
          <button
